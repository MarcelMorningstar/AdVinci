        ...
        <div className='flex flex-col gap-6 h-[70vh] justify-center'>
            ...
            <div className="flex flex-col w-full p-4 items-center">
                ...
                <div className="relative flex justify-between w-11/12 sm:w-2/3 lg:w-1/2 top-[8px]">
                    ...
                    <div
                        className={`px-3 sm:px-4 py-2 bg-white shadow-md rounded-xl text-sm md:text-base font-bold ${progress >= 50 ? "text-[var(--primary2)]" : "text-gray-600"} text-nowrap`}
                    >
                        STEP 02
                    </div>
                    <div
                        className={`px-3 sm:px-4 py-2 bg-white shadow-md rounded-xl text-sm md:text-base font-bold ${progress >= 100 ? "text-[var(--primary2)]" : "text-gray-400"} text-nowrap`}
                    >
                        STEP 03
                    </div>
                </div>
